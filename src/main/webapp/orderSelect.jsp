...
<%
    ...
    int no =0;
     try{
    	 String sql = "select to_char(orderDate, 'yyyy-mm-dd'), a.orderName, a.productId, b.name, a.unitPrice, a.orderQty, a.orderAddress from order0822 a, product0822 b where a.productId=b.productId";
